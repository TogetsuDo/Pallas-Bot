...
def test_linux_default_route_gateway_reads_proc_net_route(monkeypatch) -> None:
    from packages.pb_protocol import docker_onebot_host as m
...
def test_resolve_docker_onebot_host_from_config_reads_network_mode() -> None:
    from packages.pb_protocol.docker_onebot_host import resolve_docker_onebot_host_from_config
...
def test_build_napcat_docker_bridge_adds_host_gateway(tmp_path) -> None:
    from packages.pb_protocol.linux_docker import build_docker_run_argv
...
def test_build_snowluma_docker_adds_host_gateway(tmp_path) -> None:
    from packages.pb_protocol.snowluma_docker import build_snowluma_docker_run_argv
