...
from src.common.platform.shard.logs.errors import (
    append_shard_log_error,
    collect_cluster_log_errors_from_jsonl,
    errors_jsonl_path,
)
from src.common.platform.shard.logs.view import dedupe_mirror_stdio_lines
...
def test_append_and_collect_errors(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "src.common.platform.shard.logs.errors.shard_errors_dir",
