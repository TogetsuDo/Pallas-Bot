def test_community_contribute_enabled_defaults_true(monkeypatch):
    from src.features.corpus.config import clear_corpus_config_cache, community_contribute_enabled
    ...
    monkeypatch.setattr("src.features.corpus.store.load_corpus_community_state", dict)
...
def test_community_contribute_respects_enroll_policy_false(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.features.corpus.store.load_corpus_community_state",
