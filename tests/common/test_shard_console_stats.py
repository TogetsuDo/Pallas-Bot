...
from src.common.platform.shard import console_stats as mod
...
def test_prune_stale_worker_stats_bots_sync(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("src.common.platform.shard.registry.store.get_shard_registry", lambda: FakeReg())
