...
async def test_migrate_context_merges_duplicate_keywords(pg_env):
    ...
    from src.common.foundation.db.repository_pg import ContextAnswerMessageRow, ContextAnswerRow, ContextBanRow, ContextRow
...
async def test_migrate_message_resumable(pg_env):
    ...
    from src.common.foundation.db.repository_pg import MessageRow
...
async def test_migrate_blacklist_rerun_idempotent(pg_env):
    ...
    from src.common.foundation.db.repository_pg import BlackListRow
...
async def test_migrate_bot_config_handles_auto_accept_legacy(pg_env):
    ...
    from src.common.foundation.db.repository_pg import BotConfigRow
...
async def test_migrate_image_cache_upsert(pg_env):
    ...
    from src.common.foundation.db.repository_pg import ImageCacheRow
