...
from src.common.platform.shard.registry.store import ShardRegistry
...
def test_allocate_skips_occupied():
    ...
    with patch("src.common.platform.shard.registry.port_alloc.is_tcp_port_in_use", side_effect=fake_in_use):
