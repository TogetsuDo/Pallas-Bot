...
from pallas.core.foundation.command_prefix import extract_command_tail_any, matches_text_prefix, peel_text_prefix
from pallas.core.perm import permission_for_command, private_message_permission_for_command
from pallas.core.platform.multi_bot.group import claim_group_handler
...
async def _register_maa_plugin_coord() -> None:
    from packages.maa.endpoints import normalize_http_path
