...
from packages.duel import duel_penalty  # noqa: F401 — 注册惩罚消息 matcher
from packages.duel.config import plugin_config
from packages.duel.duel_bots import (
...
from packages.duel.duel_penalty import apply_duel_penalties
from packages.duel.duel_qte import complete_duel_qte, duel_qte_exact_rule
from packages.duel.duel_round_engine import (
    begin_duel_command,
    end_duel_group,
    play_duel_rounds,
    reload_event_pools,
...
from packages.duel.duel_session import clear_duel_pair, start_duel_pair
...
from pallas.core.storage import plugin_storage_list, plugin_storage_row
...
async def _register_duel_plugin_coord() -> None:
    from packages.duel.arknights_ops import reload_operators_cache
    from packages.duel.duel_bots import list_group_online_bot_ids, list_local_fleet_bots_in_group
    from packages.duel.duel_qte import (
        apply_cluster_qte_greeting,
        bot_qte_success_rate,
        duel_qte_blocks_greeting_user,
        pick_bot_wrong_qte_reply,
    )
    from packages.duel.duel_session import get_duel_pair, is_duel_paired_bot_traffic, should_skip_repeater_learn
    from pallas.core.platform.multi_bot.group_fleet_probe import register_fleet_probe
...
async def _ensure_duel_arknights_resources() -> None:
    from pallas.core.shared.utils.arknights_duel_resource import schedule_arknights_duel_resource_sync
...
async def _(bot: Bot, event: GroupMessageEvent, state: T_State) -> None:
    ...
    from packages.duel.shard_cage import cage_narrator_offline_for_reply, resolve_cage_duel_pair
