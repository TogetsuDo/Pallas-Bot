...
from packages.duel.duel_session import register_duel_narrative_line
from pallas.core.platform.bot_runtime.send_unavailable import is_bot_send_unavailable, log_bot_send_unavailable
...
async def _route_send_outbound(
    ...
    *,
    ...
    if inst is None:
        ...
        from pallas.core.platform.shard.coord.bot_action import send_group_message_as_bot
