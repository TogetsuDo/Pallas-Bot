...
from packages.duel.duel_bots import is_bot_qq
from packages.duel.duel_message import append_duel_message, duel_at, duel_text
from pallas.core.foundation.config import BotConfig, GroupConfig
from pallas.core.shared.utils import is_bot_admin

if TYPE_CHECKING:
    from packages.duel.duel_round_engine import DuelStacks
...
async def fetch_member_card(bot_id: int, group_id: int, user_id: int) -> str:
    from pallas.core.platform.shard.coord.bot_action import get_member_card_as_bot
...
async def set_member_card(bot_id: int, group_id: int, user_id: int, card: str) -> bool:
    from pallas.core.platform.shard.coord.bot_action import set_group_card_as_bot
    from pallas.core.platform.shard.presence import bot_has_local_connection
