...
from pallas.core.platform.multi_bot.dedup import normalize_message_time
...
async def resolve_shard_group_online_bot_ids(group_id: int) -> list[int]:
    """分片：解析本群可用 fleet 牛。"""
    from pallas.core.platform.multi_bot.fleet import get_catalog_bot_ids
    from pallas.core.platform.shard.presence import get_cluster_online_bot_ids, pick_local_query_bot
...
async def list_local_fleet_bots_in_group(group_id: int) -> list[int]:
    ...
    from pallas.core.platform.multi_bot.fleet import get_catalog_bot_ids
    from pallas.core.platform.shard.presence import pick_local_query_bot
