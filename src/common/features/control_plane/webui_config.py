...
from src.common.foundation.config.repo_settings import repo_env_raw_value, repo_webui_settings_path
...
def repair_misplaced_federate_redis_env() -> bool:
    ...
    if not changed:
        return False
    from src.common.foundation.config.repo_settings import remove_repo_settings_keys
