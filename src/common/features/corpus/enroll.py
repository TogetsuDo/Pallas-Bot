...
from src.common.features.community_stats.reporter import _headers as community_stats_headers
from src.common.features.community_stats.store import load_or_create_deployment_id
...
from src.common.features.corpus.store import (
    corpus_community_enrollment_valid,
    load_corpus_community_state,
    save_corpus_community_state,
)
from src.common.features.message_scrub.quiet_http_loggers import scrub_http_log_noise
from src.common.foundation.db.context_repo_access import invalidate_shared_context_repository
...
def should_run_corpus_auto_enroll() -> bool:
    from src.common.features.community_stats.reporter import should_run_community_stats_reporter
...
async def ensure_corpus_community_enrolled(*, force: bool = False) -> bool:
    ...
    if not should_run_corpus_auto_enroll():
        from src.common.features.corpus.config import community_configured
