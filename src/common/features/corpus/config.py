...
def persisted_community_configured() -> bool:
    from src.common.features.corpus.store import corpus_community_enrollment_valid
...
def resolved_community_api_base_urls() -> list[str]:
    ...
    try:
        ...
        from src.common.features.community_stats.endpoints import corpus_api_base_urls_for_config, is_auto_endpoint_mode
