...
if TYPE_CHECKING:
    from src.common.features.community_stats.config import CommunityStatsConfig
...
def stats_urls_for_config(cfg: CommunityStatsConfig) -> list[str]:
    from src.common.features.community_stats.stats_url import stats_url_from_endpoint
...
def monitor_overview_urls_for_config(cfg: CommunityStatsConfig) -> list[str]:
    from src.common.features.community_stats.stats_url import monitor_overview_url_from_endpoint
