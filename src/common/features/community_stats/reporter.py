...
from src.common.features.community_stats.config import CommunityStatsConfig, get_community_stats_config
...
from src.common.features.community_stats.store import (
...
from src.common.foundation.bot_version import get_pallas_bot_version_for_reporting
...
from src.common.platform.shard.registry.store import get_shard_registry, is_test_shard_record
...
def build_heartbeat_payload() -> dict[str, object]:
    from src.common.platform.shard.presence import count_connected_bots_for_reporting
