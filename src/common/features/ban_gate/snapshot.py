...
async def _load_snapshot_mongodb() -> tuple[frozenset[int], dict[int, frozenset[int]]]:
    from src.common.foundation.db.modules import GroupConfigModule, UserConfigModule
...
async def _load_snapshot_postgresql() -> tuple[frozenset[int], dict[int, frozenset[int]]]:
    ...
    from src.common.foundation.db.repository_pg import GroupConfigRow, UserConfigRow, get_session
