...
from src.common.foundation.config.repo_settings import repo_env_raw_value, repo_root
...
def coord_redis_claim_ttl_sec() -> int:
    ...
    try:
        from src.common.features.control_plane.store import load_bootstrap_claim_ttl_sec
