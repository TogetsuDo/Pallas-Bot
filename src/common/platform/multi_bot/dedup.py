...
from src.common.platform.multi_bot.claim import read_claim_owner_sync, try_claim_message
    ...
    async with _shard_ingress_file_locks[lock_key]:
        ...
        if owner is not None:
            if owner == shard_id:
                return True
            if ingress_shard_claim_owner_obsolete(owner):
                from src.common.platform.multi_bot.claim import take_claim_message
...
async def try_begin_group_owned_gate(
    ...
    *,
    ...
    if is_sharding_active():
        from src.common.platform.shard.coord.group_gate import try_begin_owned_gate_sync
...
async def try_acquire_group_broadcast_slot(
    ...
    *,
    ...
    if is_sharding_active():
        from src.common.platform.shard.coord.group_gate import try_acquire_broadcast_slot_sync
