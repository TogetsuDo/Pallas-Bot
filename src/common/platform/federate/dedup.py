...
from src.common.platform.multi_bot.dedup import cross_bot_group_message_key, cross_bot_message_signature
...
async def try_claim_cross_federate_message(
    ...
    *,
    ...
    from src.common.platform.federate.config import federate_ingress_active
    ...
    from src.common.platform.federate.redis_claim import try_claim_federate_message_redis_sync
