...
from src.common.platform.shard.logs.errors import append_shard_log_error_from_sink, log_stem_for_shard
from src.common.platform.shard.logs.session import maybe_rotate_logs_for_new_session
from src.common.platform.shard.logs.view import shard_logs_dir
...
def install_shard_process_logging() -> str | None:
    ...
    if role in ("hub", "worker"):
        from src.common.console.web import set_log_error_capture
