...
from src.common.platform.shard.ingress_metrics import merge_ingress_metrics
...
def aggregate_shard_observability() -> dict[str, Any]:
    from src.common.platform.shard.console_stats import iter_worker_shard_ids, read_worker_stats_file
