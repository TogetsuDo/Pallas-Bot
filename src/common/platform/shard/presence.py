...
def _maybe_import_file_to_redis() -> None:
    from src.common.platform.coord.redis_presence import import_file_presence_to_redis_sync
...
def _load_presence_bots() -> dict[str, dict[str, Any]]:
    from src.common.platform.coord.redis_presence import (
...
def pick_local_query_bot():
    ...
    from src.common.platform.shard.local_representative import local_worker_representative_bot_id
