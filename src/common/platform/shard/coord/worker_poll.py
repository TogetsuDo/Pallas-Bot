...
async def shard_coord_worker_poll_loop() -> None:
    ...
    from src.common.platform.shard.coord.bot_action import poll_bot_action_pending, prune_stale_bot_action_files
    ...
    from src.common.platform.shard.coord.duel_qte import poll_duel_qte_pending, prune_stale_duel_qte_files
    from src.common.platform.shard.coord.maa_pending_registry import prune_stale_maa_pending_files
    from src.common.platform.shard.coord.maa_seen_registry import prune_stale_maa_seen_files
    from src.common.platform.shard.coord.repeater_buffer import (
...
def start_shard_coord_worker_watcher() -> None:
    ...
    if get_shard_registry_settings().role != "worker":
        return
    from src.common.platform.shard.coord.repeater_buffer import start_repeater_buffer_redis_listener
