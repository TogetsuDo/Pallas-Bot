...
def merge_log_line_continuations(lines: list[str]) -> list[str]:
    ...
    from src.common.platform.shard.logs.view import _is_log_continuation_body
...
async def iter_nonebot_log_sse(
    ...
    *,
    ...
    try:
        ...
        if is_sharded_hub():
            from src.common.platform.shard.logs.view import ShardLogTailer
...
def tail_nonebot_log_lines_scoped(
    ...
    *,
    ...
    if want == "all":
        return base
    from src.common.platform.shard.logs.view import collect_shard_file_log_lines, prefix_log_source
