...
from src.common.foundation.paths import PROJECT_ROOT
...
def discover_pyproject_plugin_modules() -> list[str]:
    ...
    from src.common.platform.bot_runtime.pyproject_plugins import parse_nonebot_plugin_config
...
def discover_extra_plugin_packages() -> dict[str, Path]:
    ...
    from src.common.foundation.config.repo_settings import read_bootstrap_extra_plugin_dirs
...
def package_load_role(package: str) -> str:
    from src.common.platform.bot_runtime.roles import (
        HUB_PLUGIN_MODULES,
...
def resolve_catalog_process_role() -> str:
    ...
    from src.common.platform.bot_runtime.roles import is_sharded_hub, is_sharded_worker, is_unified_role
