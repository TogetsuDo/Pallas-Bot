...
from src.common.console.webui.field_help import field_help, normalize_field_description
...
from src.common.features.corpus.config import parse_tristate
from src.common.foundation.config.dotenv import env_value_to_str
from src.common.foundation.config.repo_settings import (
...
def control_plane_payload(*, current_values: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "module": "src.common.features.control_plane",
        "hot_reload": True,
        "fields": fields,
        "field_groups": [
            {
...
def apply_control_plane_patch(patch: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        from src.common.features.control_plane.bootstrap_client import (
        ...
        from src.common.features.control_plane.webui_config import clear_control_plane_webui_config_cache
