...
from src.common.features.corpus.webui_config import CorpusFederationWebuiConfig, get_corpus_federation_webui_config
from src.common.foundation.config.dotenv import env_value_to_str
...
def _field_row(key: str, cur: Any) -> dict[str, Any]:
    ...
    from src.common.console.webui.field_meta import field_kind_from_annotation, literal_choices
...
def corpus_federation_payload(*, current_values: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "module": "src.common.features.corpus",
        "hot_reload": True,
        "fields": fields,
        "field_groups": [
            {
...
def apply_corpus_federation_patch(patch: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        from src.common.features.community_stats.config import clear_community_stats_config_cache
    ...
    try:
        ...
        from src.common.features.community_stats.scheduler import schedule_reload_community_stats_reporter
