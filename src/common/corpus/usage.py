...
from src.common.corpus.config import community_configured, resolved_community_api_base_urls, resolved_community_token
from src.common.corpus.store import corpus_community_enrollment_valid
            ...
            async with httpx.AsyncClient(timeout=_HTTP_TIMEOUT_SEC) as client:
                for base in bases:
                    ...
                    if resp.status_code == 401:
                        from src.common.corpus.enroll import maybe_refresh_corpus_enrollment_on_auth_failure
