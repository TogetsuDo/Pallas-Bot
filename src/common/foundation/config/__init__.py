...
class TaskManager:
    ...
    async def add_task(cls, task_id: str, task_status: dict):
        ...
        from src.common.platform.shard.coord.ai_task_registry import register_ai_task
    ...
    async def remove_task(cls, task_id: str):
        ...
        from src.common.platform.shard.coord.ai_task_registry import remove_ai_task
