...
def env_key_to_section_label() -> dict[str, str]:
    ...
    try:
        from src.common.console.webui.env_sections import _registered_sections
    ...
    try:
        from src.common.console.webui.plugin_api import plugin_field_env_key
        from src.common.console.webui.plugin_catalog import discover_plugin_packages, load_config_class_for_package
