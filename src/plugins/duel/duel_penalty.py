...
async def fetch_member_card(bot_id: int, group_id: int, user_id: int) -> str:
    from src.common.platform.shard.coord.bot_action import get_member_card_as_bot
...
async def set_member_card(bot_id: int, group_id: int, user_id: int, card: str) -> bool:
    from src.common.platform.shard.coord.bot_action import set_group_card_as_bot
    from src.common.platform.shard.presence import bot_has_local_connection
