...
from src.platform.ingress.plugin_command_plaintext import extract_command_prefixes_from_menu_data
...
from src.platform.shard.coord.hosted_activity_coord import coord_session_active, hosted_activity_live
