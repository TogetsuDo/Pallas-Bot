...
from src.features.community_stats.reporter import _headers as community_stats_headers
...
from src.features.corpus.store import (
...
def should_run_corpus_auto_enroll() -> bool:
    from src.features.community_stats.reporter import should_run_community_stats_reporter
...
async def ensure_corpus_community_enrolled(*, force: bool = False) -> bool:
    ...
    if not should_run_corpus_auto_enroll():
        from src.features.corpus.config import community_configured
