...
| [Pallas 核心契约](../architecture/pallas-core-contract.md) | 语料底盘、牛格、群味、多牛社交总纲 |
| [4.0 瘦身归档](../architecture/pallas-4.0-slim.md) | 历史迁移背景、core / extra / 安装路径 |
| [AI 终态架构](../architecture/pallas-final-ai-shape.md) | Bot↔AI 契约 |
