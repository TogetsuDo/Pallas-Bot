...
完整键表以 [配置存储](../developer/architecture/config-storage.md) 与对应插件文档为准。
...
| [架构总览](../developer/architecture/overview.md) | 运行时分层与归属边界 |
| [LLM 与 AI 运维](../maintainer/operate/llm-and-ai.md) | Bot↔AI 联调与排障 |
