...
> **关系**：[Pallas 核心契约](pallas-core-contract.md)（产品与边界）· [开发者架构总览](../../developer/architecture/overview.md)（现行入口）· [内核插件统一化](core-plugin-unification-design.md)（golden 模板）
...
| [developer/plugin-development/getting-started.md](../../developer/plugin-development/getting-started.md) | 现行插件开发入口 | ✅ 已建立 |
| [developer/plugin-development/golden-plugin.md](../../developer/plugin-development/golden-plugin.md) | 现行插件骨架说明 | ✅ 已建立 |
| [developer/plugin-development/config-and-webui.md](../../developer/plugin-development/config-and-webui.md) | 现行配置入口 | ✅ 已建立 |
| [developer/plugin-development/testing.md](../../developer/plugin-development/testing.md) | 现行测试入口 | ✅ 已建立 |
