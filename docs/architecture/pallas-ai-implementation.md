...
**进官方扩展仓**（4.0 slim，见 [pallas-4.0-slim.md](pallas-4.0-slim.md)）：`pallas-plugin-draw` 的口令 handler、AI/plugin 执行路径、插件配置默认值、`startup`/`media_callback` 注册。
...
- [persona-llm-roadmap.md](persona-llm-roadmap.md) — LLM 专项  
