...
from pallas.core.platform.shard.coord.group_activity import (
...
def _read(path_or_gid: str | int) -> dict[str, Any] | None:
    ...
    from pallas.core.platform.shard.coord.coord_redis_store import read_json_sync
...
async def try_reclaim_orphan_duel_group(group_id: int) -> bool:
    from pallas.core.plugin_coord.duel import get_duel_pair
