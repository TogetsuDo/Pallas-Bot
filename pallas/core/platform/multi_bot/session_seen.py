...
def note_bot_session_seen(qq: int) -> None:
    from pallas.core.platform.multi_bot.fleet import note_fleet_bot_session_connected
...
def get_session_seen_bot_ids() -> frozenset[int]:
    ...
    from pallas.core.platform.multi_bot.fleet import get_enabled_protocol_bot_ids, get_process_session_connected_ids
