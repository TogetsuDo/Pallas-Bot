...
from src.common.shard.registry.startup_ports import (  # noqa: E402
    evaluate_protocol_port_sync,
    evaluate_registry_worker_ports,
)
from src.common.shard.registry.store import clear_shard_registry_cache, get_shard_registry  # noqa: E402
...
def main() -> int:
    ...
    if env_path is not None:
        from src.common.shard.registry.sync_protocol_ports import apply_env_for_shard_sync, read_dotenv
